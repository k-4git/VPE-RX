...
begin
   ...
   begin
    if reset = ACTIVE then
        ...
        elsif modeSwitch = ACTIVE then
             localRxOut := rxOut;       
             digit3 <= localRxOut(15 downto 12);
             digit2 <= localRxOut(11 downto 8);
             digit1 <= localRxOut(7 downto 4);
             digit0 <= localRxOut(3 downto 0);
        end if;
    end if;
   end process;
